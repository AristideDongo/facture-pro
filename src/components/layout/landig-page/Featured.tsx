...
export default function Feature() {
  ...
  }, [inView, titleControls, subtitleControls, descriptionControls, featuresListControls, imageControls]);
          ...
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              ...
              <motion.p 
                ...
                transition={{ duration: 0.7 }}
              >
                Créez et envoyez vos factures en toute simplicité.
                Gagnez en efficacité et concentrez-vous sur ce qui compte
