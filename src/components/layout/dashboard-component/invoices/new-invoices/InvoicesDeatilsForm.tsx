...
export function InvoiceDetailsForm() {
  const { invoiceDetails, setInvoiceDetails, setInvoiceDetailsValid } =
    useInvoiceStore();
  ...
  const form = useForm<InvoiceDetailsValues>({
    ...
    defaultValues: invoiceDetails || {
      ...
      notes: "",
      terms:
        "Paiement à réception de la facture. Tout retard de paiement entraînera des pénalités.",
    },
  });
